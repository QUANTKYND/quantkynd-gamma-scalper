...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        output = {
            ...
            "path_generator": path.generator_id,
            "path_config_hash": completed.path_config_hash,
            "path_hash": completed.path_hash,
            "executable_market_state_hash": completed.executable_market_state_hash,
            "run_config_hash": completed.run_config_hash,
            "policy_config_hash": completed.policy_config_hash,
            "option_cost_model_hash": completed.option_cost_model_hash,
            "futures_cost_model_hash": completed.futures_cost_model_hash,
            "runtime_risk_hash": completed.runtime_risk_hash,
            "seed": path.seed,
            "policy": policy_id,
