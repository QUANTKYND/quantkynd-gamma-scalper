...
def test_identical_content_transmissions_remain_distinct() -> None:
    first = RawMarketObservationIdentity("upstox", "same-content", provider_sequence=10, connection_id="c")
    second = RawMarketObservationIdentity("upstox", "same-content", provider_sequence=11, connection_id="c")
