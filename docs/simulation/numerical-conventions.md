...
Version integers and version strings are identity inputs, not numerical parameters. They are serialized canonically without conversion between path generator, simulator behavior, configuration schema, and manifest schema meanings.
