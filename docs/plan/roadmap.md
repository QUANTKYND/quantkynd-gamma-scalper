...
| DATA-1 point-in-time options model | ACTIVE | DATA-1.0 freezes deterministic semantics. DATA-1.1, DATA-1.2, and DATA-1.3 provide accepted semantic, persistence, catalogue-ingestion, and deterministic normalization foundations. Market-event persistence remains. |
